        ...
        public override int CompareTo(FilterCriteria criteria, CarouselItem other)
        {
            ...
            switch (criteria.Sort)
            {
                ...
                case SortMode.Author:
                    return string.Compare(BeatmapSet.Metadata.AuthorObject.Username, otherSet.BeatmapSet.Metadata.AuthorObject.Username, StringComparison.InvariantCultureIgnoreCase);
