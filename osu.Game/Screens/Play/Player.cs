...
namespace osu.Game.Screens.Play
{
    ...
    public class Player : ScreenWithBeatmapBackground
    {
        ...
        private void addOverlayComponents(Container target, WorkingBeatmap working)
        {
            target.AddRange(new[]
            {
                breakOverlay = new BreakOverlay(working.BeatmapInfo.Get().LetterboxInBreaks, DrawableRuleset.GameplayStartTime, ScoreProcessor)
                {
        ...
        private IBeatmap loadPlayableBeatmap()
        {
            ...
            try
            {
                ...
                rulesetInfo = Ruleset.Value ?? Beatmap.Value.BeatmapInfo.Get().Ruleset;
                ...
                catch (BeatmapInvalidForRulesetException)
                {
                    ...
                    rulesetInfo = Beatmap.Value.BeatmapInfo.Get().Ruleset;
                    ruleset = rulesetInfo.CreateInstance();
