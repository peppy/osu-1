    ...
    public class OsuGame : OsuGameBase, IKeyBindingHandler<GlobalAction>
    {
        ...
        private void load(FrameworkConfigManager frameworkConfig)
        {
            ...
            Ruleset.BindValueChanged(r =>
            {
                ...
                // todo: shouldn't be using online id
                configRuleset.Value = r.NewValue.OnlineID.Value;
            }, true);
        ...
        public void PresentBeatmap(BeatmapSetInfo beatmap)
        {
            ...
            performFromMainMenu(() =>
            {
                ...
                var first = databasedSet.Beatmaps.FirstOrDefault(b => b.Ruleset.Equals(Ruleset.Value)) ?? databasedSet.Beatmaps.First();
        ...
        {
            BeatmapDifficulty baseDifficulty = Beatmap.Value.BeatmapInfo.Get().BaseDifficulty;
