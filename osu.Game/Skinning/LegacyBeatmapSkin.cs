...
namespace osu.Game.Skinning
{
    public class LegacyBeatmapSkin : LegacySkin
    {
        ...
        public LegacyBeatmapSkin(BeatmapInfo beatmap, IResourceStore<byte[]> beatmapStorage, IStorageResourceProvider resources)
            : base(createSkinInfo(beatmap), new WrappedStorageResourceProvider(resources, beatmapStorage), beatmap.Path)
        {
